use crate::day5_part2::Instruction::{Add1, Multiply2, Input3, Output4, Halt99, JumpIfTrue5, JumpIfFalse6, LessThan7, Equals8};
use crate::day5_part2::ParameterMode::{PositionMode0, ImmediateMode1};
    ...
    loop {
        ...
        match instruction {
            ...
            Input3 => {
                ...
                println!("gave 5 as input...");
                proggy[position] = "5".to_owned();
                current_pos += 2;
            },
            Output4(mode) => {
